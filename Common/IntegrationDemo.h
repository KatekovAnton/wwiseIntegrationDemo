...
public:
	...
	AkOutputDeviceID& GetOutputDeviceIdRef() { return m_outputDeviceId; }
	AkOutputDeviceID GetOutputDeviceId() const { return m_outputDeviceId; }
...
private:
	...
	// Active output device for default Audio Device Shareset, and primary audio device
	AkOutputDeviceID m_outputDeviceId; 
